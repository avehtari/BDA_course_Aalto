...
mu_interval <- function(data) c(13.3, 15.7)
mu_pred_point_est <- function(data) 14.5
mu_pred_interval <- function(data) c(11.8, 17.2)
@
...
% See exercises/solution folder in teacher repo
<<echo=FALSE>>=
posterior_odds_ratio <- function(p0, p1) c(0.569,0.440,0.595,0.882,0.391)
@
...
<<echo=TRUE>>=
p0 <- c(0.06480697, 0.05696637, 0.05931916, 0.03985734, 0.05275953)
p1 <- c(0.03793276, 0.02587435, 0.03616679, 0.03532958, 0.02129371)
posterior_odds_ratio(p0, p1)
@
