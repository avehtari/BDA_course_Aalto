...
\textbf{Reading instructions:} Chapter 7 in BDA3, see \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/chapter_notes/BDA_notes_ch7.pdf}{\textbf{here}}. Also read the paper on PSIS-LOO that can be found \href{https://link.springer.com/article/10.1007/s11222-016-9696-4}{\textbf{here}} or \href{https://arxiv.org/pdf/1507.04544}{\textbf{here}}.


\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 8 can be found \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/exercises/ex8_rubric.md}{\textbf{here}}
