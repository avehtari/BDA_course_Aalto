...
test_that("posterior_odds_ratio_interval()", {  
  ...
  expect_equal(unname(posterior_odds_ratio_interval(p0,p1, 0.9)), c(0.875367, 6.059110), tol= 0.1, info = "Error: Incorrect result for p0 = rbeta(100000, 5, 95), p1 = rbeta(100000, 10, 90) and 90%.")
  expect_equal(unname(posterior_odds_ratio_interval(p1,p0, 0.9)), c(0.1650407, 1.1423780), tol= 0.01, info = "Error: Incorrect result for p1 = rbeta(100000, 5, 95), p0 = rbeta(100000, 10, 90) and 90%.")
  expect_equal(unname(posterior_odds_ratio_interval(p1,p0, 0.8)), c(0.2086461, 0.9392956), tol= 0.01, info = "Error: Incorrect result for p1 = rbeta(100000, 5, 95), p0 = rbeta(100000, 10, 90) and 80%.")
