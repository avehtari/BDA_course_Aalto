...
\textbf{Hint!} Use the function {\tt rmvnorm} from the {\tt aaltobda} package. Below is an example how the function would work with the example values for {\tt alpha} and {\tt beta} above.
\begin{Schunk}
\begin{Sinput}
> alpha
\end{Sinput}
