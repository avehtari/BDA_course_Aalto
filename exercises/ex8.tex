...
%\item In the hierarchical model, use the same measurement standard deviation $\sigma$ for all the groups, similarly as in the book (Sec.~11.6) and in Assignment~7.
