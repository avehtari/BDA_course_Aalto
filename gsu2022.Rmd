---
title: "Bayesian Data Analysis course - GSU 2022"
date: "Page updated: `r format.Date(file.mtime('gsu2022.Rmd'),'%Y-%m-%d')`"
---

Bayesian Data Analysis Global South (GSU) 2022

- Lecturer: [Aki Vehtari](https://users.aalto.fi/~ave/index.html)
- Head TAs: [Meenal Jhajharia](https://mjhajharia.com) and Santiago Marin Ardila
- Sponsored by:
...
1. From 19th February (first assignment deadline 27th February, last day of the course 18th May)
...
You can apply for the course by filling [a registration form](https://forms.gle/T42PnPRzCxvugAiL7). The registration form asks several pre-requisites questions, and filling the form takes some time. We will email whether you have been accepted to the course at latest 18th February. If you are not accepted for the course, you can still self-study all the material.
...
you can be a TA)  in [TA registration form](https://forms.gle/8ykKoe4gsX7rqM22A).
...
- Make and submit [Assignment 1](assignments/assignment1.pdf). **Deadline Sunday 27 February 23:59 UTC+0**
...
- Make and submit [Assignment 2](assignments/assignment2.pdf). **Deadline Friday 4 March 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 2](assignments/assignment2_rubric.html)
    - Review Assignment 1 done by your peers before 23:59 UTC+0 2 March
...
- Make and submit [Assignment 3](assignments/assignment3.pdf). **Deadline Friday 11 March 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 3](assignments/assignment3_rubric.html)
    - Review Assignment 2 done by your peers  before 23:59 UTC+0 9 March, and reflect on your feedback
...
- Make and submit [Assignment 4](assignments/assignment4.pdf). **Deadline Friday 25 March 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 4](assignments/assignment4_rubric.html)
    - Review Assignment 3 done by your peers before 23:59 UTC+0 23 March, and reflect on your feedback
...
- Make and submit [Assignment 5](assignments/assignment5.pdf). **Deadline Friday 1 April 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 5](assignments/assignment5_rubric.html)
    - Review Assignment 4 done by your peers before 23:59 UTC+0 30 March, and reflect on your feedback
...
- Make and submit [Assignment 6](assignments/assignment6.pdf). **Deadline Friday 8 April 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 6](assignments/assignment6_rubric.html)
    - Review Assignment 5 done by your peers before 23:59 UTC+0 6 April, and reflect on your feedback
...
- Make and submit [Assignment 7](assignments/assignment7.pdf). **Deadline Friday 22 April 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 7](assignments/assignment7_rubric.html)
    - Review Assignment 6 done by your peers before 23:59 UTC+0 20 April, and reflect on your feedback
...
- Additional reading material
    - [Model selection](https://avehtari.github.io/modelselection/)
    - [Cross-validation FAQ](https://avehtari.github.io/modelselection/CV-FAQ.html)
- Make and submit [Assignment 8](assignments/assignment8.pdf). **Deadline Friday 29 April 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 8](assignments/assignment8_rubric.html)
    - Review Assignment 7 done by your peers before 23:59 UTC+0 27 April, and reflect on your feedback
...
- Make and submit [Assignment 9](assignments/assignment9.pdf). **Deadline Friday 6 May 23:59 UTC+0**
    - [Rubric questions used in peergrading for Assignment 9](assignments/assignment9_rubric.html)
    - Review Assignment 8 done by your peers before 23:59 UTC+0 4 May, and reflect on your feedback
...
- No new assignment. Work on project. 
    - Review Assignment 9 done by your peers before 23:59 UTC+0 11 May, and reflect on your feedback
...
- Watch [Lecture 12.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=e998b5dd-bf8e-42da-9f7c-ab1700ca2702) on frequency evaluation, hypothesis testing and variable selection and [Lecture 12.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=c43c862a-a5a4-45da-9b27-ab1700e12012) overview of modeling data collection, BDA3 Ch 8, linear models, BDA Ch 14-18, lasso, horseshoe and Gaussian processes, BDA3 Ch 21.
    - [Slides](https://github.com/avehtari/BDA_course_Aalto/tree/master/slides)
- Work on project. TAs help with projects. **Project deadline 13 May 23:59 UTC+0**

### 13) Project evaluation

- Project report deadline 13 May 23:59 UTC+0 (submit to peergrade).
    - Review project reports done by your peers before 18 May 23:59 UTC+0, and reflect on your feedback
