...
\begin{frame}
  ...
  \begin{center}
  \only<1>{\includegraphics[width=9cm]{dbinom1.pdf}}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Gabry et al (2017). Visualization in Bayesian workflow.
    \only<1>{
    \begin{itemize}
...
%   \begin{itemize}
%   \item Let's collect some data\\
%   \url{https://goo.gl/forms/c9asEqJMDQ061hj03}
% \end{itemize}
