...
\begin{frame}
  ...
  Example: $n=10, y=10$
  \begin{center}
  \includegraphics[width=8cm]{binom_10_10_hist.pdf}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
  \includegraphics[width=7.8cm]{binom_10_10_hist.pdf}\\
  \includegraphics[width=7.8cm]{binom_12_11_hist.pdf}
  \end{center}
