...
\end{minipage}
  ...
  \uncover<5->{$\downarrow$
    ...
    updated uncertainty\\
    \uncover<6->{+\\ updated expert information}}
...
\begin{frame}{Probabilistic programming and Stan}
  ...
  50+ developers, 100+ contributors, 400K+ users, 300+ other software
  packages built on top of Stan

  \center
  \vspace{\baselineskip}
  \includegraphics[width=3cm]{Stan_logo_blue_tm.png}\\
  mc-stan.org
