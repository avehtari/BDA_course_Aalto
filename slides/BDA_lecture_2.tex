...
\begin{document} 
 ...
 \begin{frame}{Outline of Lecture 2}
   ...
   \item Binomial model is the simplest model
     \begin{itemize}
     \item useful to introduce observaion model, likelihood,
...
\begin{frame}
  \frametitle{Binomial: unknown $\theta$ and $y=6$}
...
\begin{frame}{Left handedness}
  ...
  \item If we would like to provide scissors for all students, how
    ...
    \end{itemize}
  \item {\color{red} Posterior predictive} distribution for several
    future trials is Beta-Binomial
    \pause
    \item Demo: \url{https://huggingface.co/spaces/Madhav/Handedness}
  \end{itemize}
...
\begin{frame}{Beta prior for Binomial model}
  ...
  \item<5-> Left handedness weakly informative prior with 95\%
    probability mass in interval $[5,20]$ with $\alpha=8$ and
    $\beta=60$
  \end{itemize}
\end{frame}
...
\begin{frame}{Benefits of integration and prior}
  ...
  \begin{itemize}
  \item Left handed simulation with 30 left handeded and 300 total
  \end{itemize}
...
\begin{frame}{Benefits of integration and prior}
  ...
  \item Left handed simulation with 30 left handeded and 300 total
    ...
    \item average log predictive density for 30 left handeded in total
    \end{itemize}
  \end{itemize}
...
\end{frame}
 ...
 \begin{frame}
   ...
   \item<2-> The mean can be also a function of covariates
     \begin{itemize}
     \item e.g. normal linear regression
     \end{itemize}
   \end{itemize}
 \end{frame}
