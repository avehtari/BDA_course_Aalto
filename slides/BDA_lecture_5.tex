...
\begin{frame}[fragile]
  ...
  Normal variance mixture {\hspace{.2cm}$\rightarrow$ folded}{\hspace{2.4cm} $\rightarrow$ {ranks}}

  \begin{minipage}[t][5cm][t]{1.5\linewidth}
  \hspace{-10mm}
    {\includegraphics[width=12cm]{tmp.png}}
  \end{minipage}   
...
\begin{frame}[fragile]
  ...
  Normal variance mixture {\hspace{.2cm}$\rightarrow$ folded}{\hspace{2.4cm} $\rightarrow$ {inverse cdf}}

  \begin{minipage}[t][5cm][t]{1.5\linewidth}
  \hspace{-10mm}
    {\includegraphics[width=12cm]{tmp2.png}}
  \end{minipage}   
