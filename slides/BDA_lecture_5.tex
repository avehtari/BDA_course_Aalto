...
\begin{frame}{Monte Carlo}
  ...
  \item<1-> Monte Carlo methods we have discussed so far
    ...
    \end{itemize}
    \only<2>{\includegraphics[width=8cm]{norm1d_2.pdf}}
    \only<3>{\includegraphics[width=8cm]{norm1d_7.pdf}}
    \only<4>{\includegraphics[width=8cm]{bioassay_grid3_2.pdf}}
  \item<5-> What to do in high dimensions?
    \begin{itemize}
...
\begin{frame}{Diagnostic tools}
  ...
  \item<+-> $\widehat{R}$, ESS, mean, MCSE of mean in R
    ...
    \item \texttt{summarise\_draws(th, basic\_rhat, basic\_ess)}
