...
\begin{frame}{Normal / Gaussian}
  ...
  \begin{align*}
    p({y}|\mu,\sigma)&=\frac{1}{\sqrt{2\pi}\sigma}\exp\left(-\frac{1}{2\sigma^2}{\color{red}({y}-\mu)^2}\right)
  \end{align*}
    \centering
  \includegraphics[height=4cm,clip]{lec3_normal2}
  }\only<3>{
  \begin{align*}
    p({y}|\mu,\sigma)&=\frac{1}{\sqrt{2\pi}\sigma}\exp\left({\color{red}-}\frac{1}{2\sigma^2}{\color{red}({y}-\mu)^2}\right)
  \end{align*}
    \centering
  \includegraphics[height=4cm,clip]{lec3_normal3}
  }\only<4>{
  \begin{align*}
    p({y}|\mu,\sigma)&=\frac{1}{\sqrt{2\pi}\sigma}\exp\left({\color{red}-\frac{1}{2\sigma^2}({y}-\mu)^2}\right)
  \end{align*}
    \centering
  \includegraphics[height=4cm,clip]{lec3_normal4}
  }\only<5>{
  \begin{align*}
    p({y}|\mu,\sigma)&=\frac{1}{\sqrt{2\pi}\sigma}{\color{red}\exp\left(-\frac{1}{2\sigma^2}({y}-\mu)^2\right)}
  \end{align*}
    \centering
  \includegraphics[height=4cm,clip]{lec3_normal5}
  }\only<6>{
  \begin{align*}
    p({y}|\mu,\sigma)&={\color{red}\frac{1}{\sqrt{2\pi}\sigma}\exp\left(-\frac{1}{2\sigma^2}({y}-\mu)^2\right)}
  \end{align*}
    \centering
  \includegraphics[height=4cm,clip]{lec3_normal6}
  }\only<7-8>{
