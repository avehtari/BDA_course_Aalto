    ...
    \begin{itemize}
      ...
      \item[2.] $t=1,2,\ldots$
        ...
        \item[(a)] pick a proposal $\theta^{*}$ from the proposal distribution
          ...
          $J_t({\color{blue} \theta_a}|{\color{red} \theta_b})=J_t({\color{red} \theta_b}|{\color{blue} \theta_a})$, for all
...
\begin{frame}{Why Metropolis algorithm works}
  ...
  \item[2.] Prove that this stationary distribution is the desired target distribution $p(\theta|y)$
    ...
    \item<2->[-] consider any two such points ${\color{blue} \theta_a}$ and ${\color{red} \theta_b}$ drawn
      ...
      $p({\color{red} \theta_b}|y)\geq p({\color{blue} \theta_a}|y)$
    \item<3->[-] the unconditional probability density of a transition from ${\color{blue} \theta_a}$ to ${\color{red} \theta_b}$ is
      ...
      \begin{equation*}
        ...
        p({\color{blue} \theta_a}|y)J_t({\color{red} \theta_b}|{\color{blue} \theta_a}),
      \end{equation*}
    ...
    \item<4->[-] the unconditional probability density of a transition from ${\color{red} \theta_b}$ to ${\color{blue} \theta_a}$ is
      ...
      \begin{eqnarray*}
        ...
        p({\color{red} \theta_b}|y)J_t({\color{blue} \theta_a}|{\color{red} \theta_b})\left(\frac{p({\color{blue} \theta_a}|y)}{p({\color{red} \theta_b}|y)}\right)\\
        \pause &  = &  p({\color{blue} \theta_a}|y)J_t({\color{blue} \theta_a}|{\color{red} \theta_b}),
      \end{eqnarray*}
      \uncover<5->{
