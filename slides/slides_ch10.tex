...
\begin{frame}{Example: Kilpisjärvi summer temperature}
  ...
  \begin{center}
    ...
    \only<3>{$\sigma_\theta\approx 0.83,\, \text{MCSE} \approx 0.083,$\\ in repeated sampling we may expect mean estimate to vary within (1.8, 2.1) (90\% interval)}
...
\begin{frame}{Some uses of importance sampling}
  ...
  number of dimensions increase, but there are many use case
...
\begin{frame}{Example: Importance sampling in Bioassay}
       ...
       \includegraphics[width=8cm]{bioassayisw2.pdf}\\
         ...
         \begin{align*}
           ...
           S_{\rm eff} & \approx 396 \\
         \end{align*}
       \end{center}
       
         \vspace{-2\baselineskip}
         \uncover<2->{If all $\tilde{w}(\theta^s)=1/S$, then $S_{\rm eff}=1/(SS^{-2})=S$\\}
         \uncover<3->{If one $\tilde{w}(\theta^s)=1$, and others $0$, then $S_{\rm eff}=1/1=1$}
...
\begin{frame}{Example: Importance sampling in Bioassay}
       ...
       \includegraphics[width=8cm]{bioassayisw2.pdf}\\
         ...
         \begin{align*}
           S_{\rm eff} & = \frac{1}{\sum_{s=1}^S (\tilde{w}(\theta^s))^2}, \quad \text{is based on variance of } \tilde{w}(\theta^s) \\
           S_{\rm eff} & \approx 396 \\ \uncover<1->{&\text{Pareto-$k$ diagnostic preferably $<$ 0.7: }}\uncover<2->{ \hat{k} \approx 0.65}
         \end{align*}
  \end{center}
...
\begin{frame}{Example: Importance sampling in Bioassay}
       ...
       \includegraphics[width=8cm]{bioassayisw2.pdf}\\
         ...
         \begin{align*}
           S_{\rm eff} & = \frac{1}{\sum_{s=1}^S (\tilde{w}(\theta^s))^2}, \quad \text{is based on variance of } \tilde{w}(\theta^s) \\
           S_{\rm eff} & \approx 396 \\ \uncover<1->{&\text{Pareto-$k$ diagnostic preferably $<$ 0.7: }}\uncover<1->{ \hat{k} \approx 0.65}
         \end{align*}
  \end{center}
