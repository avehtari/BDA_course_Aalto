...
\begin{frame}{Outline}
  ...
  \begin{itemize}
  \item Prior/likelihood sensitivity checks
...
\begin{frame}{Prior/likelihood sensitivity checks}

  \begin{itemize}
  \item  Insert slides here
  \end{itemize}
...
\begin{frame}{Bayesian Python packages}
  ...
  \item Workflow packages
    \begin{itemize}
      ...
      \item \href{https://kulprit.readthedocs.io}{Kulprit}, projective inference (still under development)
    \end{itemize}
  \end{itemize}

\url{https://link-to-demo}
