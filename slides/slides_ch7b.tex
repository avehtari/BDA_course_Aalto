...
\item Two different problems
  ...
  \end{itemize}\pause
  I will focus ghere to the first case
\end{itemize}
...
\begin{frame}{}
  ...
  \begin{itemize}
  \item Projection predictive approachh works well also for small $n$, large $p$
  \item See references for examples with $n = 54...102$, $p=1536...22283$
    \begin{itemize}
    \item could scale to bigger $n$ and bigger $p$
    \end{itemize}
  \item Good priors for the referenece modelo necessary
    \begin{itemize}
    \item shrinkage priors, hierarchical shrinkage priors
    \item dimension reduction with factor models
    \end{itemize}
