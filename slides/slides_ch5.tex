...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical model and group size}

    \hspace{0.2cm} Separate \hspace{4.3cm} Hierarchical
  \begin{minipage}[b]{12cm}
    {  \hspace{-0.7cm}~\includegraphics[width=6cm]{radon2.pdf}\includegraphics[width=6cm]{radon4.pdf}}
  \end{minipage}
...
\begin{frame}
  ...
  {\Large\color{navyblue} Exchangeability - Counter example}
