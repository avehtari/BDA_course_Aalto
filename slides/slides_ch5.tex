...
\pdfinfo{
  /Title      (Bayesian data analysis 5)
  /Author     (Aki Vehtari) %
...
\begin{frame}
  ...
  {\Large\color{navyblue} Chapter 5}

  \begin{itemize}
\item 5.1 Lead-in to hierarchical models
\item 5.2 Exchangeability (important concept)
\item 5.3 Bayesian analysis of hierarchical models (we can do computation with Stan)
\item 5.4 Hierarchical normal model (we can do computation with Stan)
\item 5.5 Example: parallel experiments in eight schools (uses hierarchical normal model, part of exercises)
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical model}
...
\begin{frame}[fragile]
  ...
  {\Large\color{navyblue} Hierarchical model: terms}
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical binomial model: rats}
...
\begin{frame}[fragile]
  ...
  \item Hierarchical binomial model for rats\\
    ...
    \begin{minipage}[t]{4cm}
      \xygraph{
        []              !O{y_j}
        ([u]   !V{{\color{forestgreen}\theta_j}}  !P{y_j}
        ([u][l(0.33)] !V{\color{red} \alpha} !P{{\color{forestgreen}\theta_j}},
        [u][r(0.33)] !V{\color{red} \beta}  !P{{\color{forestgreen}\theta_j}}),
        [u][r(0.75)]  !F{n_j}    !P{y_j},
        [r(1.0)]*{j},
        [l(3.0)]*{y_j|n_j,{\color{forestgreen}\theta_j} \sim \Bin(y_j|n_j,{\color{forestgreen}\theta_j})},
        [u][l(2.93)]*{{\color{forestgreen}\theta_j}|{\color{red}\alpha,\beta} \sim
          \Beta({\color{forestgreen}\theta_j}|{\color{red}\alpha,\beta})},
        [l(6.0)]*{~}
        )
        !B{{\color{forestgreen}\theta_j}}{j}{++}
      }
    \end{minipage}
    %\pause
    \item Joint posterior
      $p({\color{forestgreen}\theta_1,\ldots,\theta_J},{\color{red}\alpha},{\color{red}\beta}|y)$
      \begin{itemize}
    \item multiple parameters
      \pause
      \item factorize
        $\prod_{j=1}^J p({\color{forestgreen}\theta_j}|{\color{red}\alpha,\beta},y)p({\color{red}\alpha,\beta}|y)$
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Population prior $\Beta({\color{forestgreen}\theta_j}|{\color{red}\alpha,\beta})$
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical normal model: factory}
...
\xygraph{
 ...
 ([u][l(0.33)] !V{\mu_P}      !P{\theta_j},
  ...
  [r(0.45)]*{i},
  [r(0.9)]*{j},
[l(3)]*{y_{ij}|\theta_j \sim \N(\theta_j,\sigma_j^2)},
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical normal model: 8 schools}
  ...
  \item SAT
    \begin{itemize}
    \item standardised multiple choice test
...
\begin{frame}
  ...
  \item Effectiveness of the SAT coaching
    ...
    \item linear regression was used to estimate the coaching effect
      $y_j$ for the shool $j$ (could be denoted with $\bar{y}_{.j}$,
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical normal model for group means}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Counter example: A six sided die with probabilities (a finite sequence!)
    $\theta_1,\ldots,\theta_6$
    \begin{itemize}
...
\end{frame}
 ...
 \begin{frame}
   ...
   \begin{itemize}
   \item See examples in the BDA\_notes\_ch5.pdf
   \end{itemize}
...
\begin{frame}
  ...
  {\Large\color{navyblue} Exchangeability and additional information}
...
\begin{frame}
  ...
  {\Large\color{navyblue} Hierarchical exchangeability}
