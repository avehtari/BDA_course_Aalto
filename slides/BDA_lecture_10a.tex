...
\item You decide to earn money by selling a seasonal product
  ...
  \end{list2}
\end{list1}
\uncover<2>{\includegraphics[width=9cm]{sales_dist1.pdf}}
...
\begin{frame}{Example of decision making: several choices}
  ...
  \only<2>{\vspace{-1\baselineskip}\includegraphics[width=9cm]{sales_utility_20_30.pdf}}
  \only<3>{\vspace{-1\baselineskip}\includegraphics[width=9cm]{sales_utilprob_20_30.pdf}}
  \only<4>{\vspace{-1\baselineskip}\includegraphics[width=9cm]{sales_utilprob_exputil_20_30.pdf}}
  \only<5>{\vspace{-1\baselineskip}\includegraphics[width=9cm]{sales_exputil.pdf}}
