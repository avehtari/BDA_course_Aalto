...
\begin{frame}
  ...
  \item TAs: \textbf{Osvaldo Martin}, Maksim Sinelnikov, Saku Suorsa, Florence Bockting, Herman Tesso,  Soham Mukherjee, Otto Vintola, Hussein Shuceyb, Ignacio Wąsowicz-Peinado, Dung Nguyen, Adrian Alfatoni
    \end{itemize}
...
\begin{frame}
  ...
  \item Supporting material and assignments in
    ...
    \end{itemize}
   \item R demos {\small\url{https://avehtari.github.io/BDA_course_Aalto/demos.html#bda-r-demos}}
  \item (Python demos {\small\url{https://avehtari.github.io/BDA_course_Aalto/demos.html#bda-python-demos})}
