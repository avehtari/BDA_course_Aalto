...
\begin{frame}
  \frametitle{Bayesian data analysis (Aalto fall 2026)}  %
  \framesubtitle{Practical matters}
  
  \begin{itemize}
  \item Book: Bayesian Data Analysis. Gelman et al. Third Edition. {\footnotesize (online pdf available)}
  \item More information: including timetable, assignments, and lecture slides. {\small\url{https://avehtari.github.io/BDA_course_Aalto/Aalto2026.html}}
  \item Lecturers: Aki Vehtari, Osvaldo Martin
  \item TAs: Maksim Sinelnikov, Saku Suorsa, Florence Bockting, Herman Tesso,  Soham Mukherjee, Otto Vintola, Hussein Shuceyb, Ignacio Wąsowicz-Peinado, Dung Nguyen, Adrian Alfatoni
    \end{itemize}
...
\begin{frame}
  ...
  \item Project report deadline 29th November
  \item Project presentations on week starting 7th December
  \end{itemize}
...
\begin{frame}
  ...
  \item Supporting material and assignments in
    {\small\url{https://avehtari.github.io/BDA_course_Aalto/Aalto2026.html}}
    \begin{itemize}
    ...
    \end{itemize}
   \item R and Python demos {\small\url{https://avehtari.github.io/BDA_course_Aalto/demos.html}}
...
\begin{frame}
  ...
  \item It's OK to use AI, but need to mention when and how used
    \begin{itemize}
    \item Warning: Some LLMs can provide very vague
    ...
    \item Relying too much on AI will hinder your learning
    \end{itemize}
...
\begin{frame}
  ...
  \item Choose your own time to take the e-exam in period II%from 18 November to 13 December
  \end{itemize}
...
\begin{frame}
  ...
  \framesubtitle{bda2026.zulip.aalto.fi}
