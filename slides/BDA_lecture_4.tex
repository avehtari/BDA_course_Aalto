...
\begin{frame}{How many simulation draws are needed?}
  ...
  \item Expectation of unknown quantity $\E(\theta)\approx \frac{1}{S}\sum_{s=1}^S \theta^{(s)}$
    ...
    \only<4>{
      \includegraphics[width=9.5cm]{N1c.pdf}\\ \vspace{-0.5\baselineskip} ~}
    \only<5>{
      \includegraphics[width=9.5cm]{N1d.pdf}\\ \vspace{-0.5\baselineskip} ~}
    \only<6>{
    ...
    \only<8>{
      \includegraphics[width=9.5cm]{exp1d.pdf}\\ \vspace{-0.5\baselineskip} ~}
\end{itemize}
