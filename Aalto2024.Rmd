...
**Updating the 2024 course web pages has started, but there may be
some old information.** A big change in the course is the reduced use
of peergrading as the previously used system was shut down, which
means also substantial changes in the assignments. **The assignment
instructions are changing and the currently linked instructions are
for year 2023.**
...
-   Make and submit [Old Assignment 1](assignments/assignment1.html).
    **Deadline
