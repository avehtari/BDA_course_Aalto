...
most important. Afer reading the chapter or following the
...
- 1.1-1.4, 1.6-1.8 ([model solutions available for 1.1-1.6](http://www.stat.columbia.edu/~gelman/book/solutions3.pdf))
...
Chapter 2 is related to the prerequisities and Lecture 2 *Basics of Bayesian inference*.
...
- 2.1-2.5, 2.8, 2.9, 2.14, 2.17, 2.22 ([model solutions available for
...
- 3.1: Visualise joint density and marginal densities of posterior
...
- 3.2: Visualise factored sampling and corresponding marginal and
...
- 3.3: Visualise marginal distribution of $\mu$ as a mixture of
...
- 3.4: Visualise sampling from the posterior predictive
...
- 3.5: Visualise Newcomb's data. [R](https://avehtari.github.io/BDA_R_demos/demos_ch3/demo3_5.html). [Python](https://github.com/avehtari/BDA_py_demos/blob/master/demos_ch3/demo3_5.ipynb).
- 3.6: Visualise posterior in bioassay example. [R](https://avehtari.github.io/BDA_R_demos/demos_ch3/demo3_6.html). [Python](https://github.com/avehtari/BDA_py_demos/blob/master/demos_ch3/demo3_6.ipynb).
...
BDA3 p. 67 mentions that the conjugate prior for normal
...
Chapter 4 is related to the Lecture 11 *Normal approximation,
...
See BDA3 p. 21 for the explanation how to derive densities for transformed
...
- 5.1 and 5.2 ([model solution available for 5.3-5.5,
...
Finetti's theorem (BDA3 p. 105), which applies formally only when
...
(BDA3 p.  128--) recommends use of half-Cauchy as weakly informative
...
- 6.1 ([model solution available for 6.1, 6.5-6.7](http://www.stat.columbia.edu/~gelman/book/solutions3.pdf))
...
- 8.1 Bayesian inference requires a model for data collection (imporant)
- 8.2 Data-collection models and ignorability
- 8.3 Sample surveys
- 8.4 Designed experiments
- 8.5 Sensitivity and the role of randomization (imporant)
- 8.6 Observational studies (pp. 220--222 important)
- 8.7 Censoring and truncation (importnat)
...
- 10.1, 10.2 ([model solution available for 10.4](http://www.stat.columbia.edu/~gelman/book/solutions3.pdf))
...
- 11.1 ([model solution available for 11.1](http://www.stat.columbia.edu/~gelman/book/solutions3.pdf))

### Basics of Markov chains

[Slides by J. Virtamo for the course S-38.143 Queueing
...
- Regression for causal inference: incumbency and voting
    - Modelling example with bit of discussion on causal inference
      ([see more in Regression and Oher Stories (ROS)](https://avehtari.github.io/ROS-Examples/) Chs. 18-21)
