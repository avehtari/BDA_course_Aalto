...
distribution given the draws from that distribution. The tail shape
indicates whether the distribution has finite variance and mean.
...
- Monte Carlo estimates (including importance sampling) can be
  improved using Pareto-smoothing, which will be discussed later.
