...
**Aalto students should check [the Aalto 2026 specific course web page](Aalto2026.html) and [MyCourses](https://mycourses.aalto.fi/course/view.php?id=47496).**
...
## Prerequisites
 ...
 - Basic visualisation techniques
     ...
     - see e.g. [BDA R demos](demos.html#bda-r-demos)
     - see e.g. [BDA Python demos](demos.html#bda-python-demos)
...
This material is not required for the course, but useful for going deeper into Bayesian workflow in practice

- [Bayesian Workflow](https://users.aalto.fi/~ave/Bayesian-Workflow.pdf) book
  * Cases studies with R: [https://avehtari.github.io/Bayesian-Workflow/](https://avehtari.github.io/Bayesian-Workflow/)
  * Cases studies with Python: [https://arviz-devs.github.io/bayesian-workflow/](https://arviz-devs.github.io/bayesian-workflow/)

- [Exploratory Analysis of Bayesian Models](https://arviz-devs.github.io/EABM/), a hands-on e-book on visualizing and diagnosing Bayesian models using ArviZ (Python), covering prior and posterior checks, convergence diagnostics, and model comparison.
...
- [Computational probabilistic modeling in 15 mins](https://www.youtube.com/watch?v=ukE5aqdoLZI)
...
The 2025 lecture videos are in [a Panopto folder](https://aalto.cloud.panopto.eu/Panopto/Pages/Sessions/List.aspx#folderID=%22f1a49586-a32a-4a52-8aa0-b34700b93e8b%22).
...
- [CmdStanPy installation](https://mc-stan.org/cmdstanpy/installation.html)
