...
If you want limit your time usage for the course, choose one or more assignments and be active before deadlines for those assignments. Read that assignment and solve it in your mind or even better solve it completely so you know how to help. Instead of assignments you can choose also to focus on answering R, Python or Stan questions.	Add your course slack id in [a sheet](https://docs.google.com/spreadsheets/d/1IKLhFgu3yM97BQWW999kdEZWWVIoKkjEfedBZJQAWyc/edit?usp=sharing) so we can see that each assignment gets enough TA love.
