...
Aalto 2020 course will be completely online.
 ...
 - Most of the communication happens in [the course chat](#Communication_channels)
...
- [MyCourses](https://mycourses.aalto.fi/user/index.php?id=28239) is used for important announcements and some questionnaires.
- Primary communication channel is the course chat.
    - Login with Aalto account to [the course chat](https://cs-e5710-2020.chat.aalto.fi/)
    - If you have any questions, please try to ask the course staff or other students there (active students helping others will get bonus points).
...
- A weekly Q&A session with the lecturer happens in Zoom webinar (see times below)
    ...
    - Q&A session will remind about the important announcement
    - Zoom webinar Q&A feature, chat, and audio talking will be used for questions
