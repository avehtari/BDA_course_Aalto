...
obtained from both the exercises and project work.
...
- **Make [Assignment 1](exercises/ex1.pdf). Deadline Sunday 13.9. 23:59**
    - this assignment checks that you have sufficient prerequisite skills (basic probability calculus, and R or Python)
	- [Rubric questions used in peergrading for Assignment 1](exercises/ex1_rubric.html)
	...
	- [FAQ for the exercises](FAQ.html) has solutions to commonly asked questions related RStudio setup, errors during package installations, etc.
...
- **Make [Assignment 2](exercises/ex2.pdf). Deadline Sunday 20.9. 23:59**
	- [Rubric questions used in peergrading for Assignment 2](exercises/ex2_rubric.html)
