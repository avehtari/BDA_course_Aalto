...
You can access all the course material thorugh these web pages, or download everything. Instead of downloading each file separately via Github interface, you can do one of the following:
 ...
 - If you don't want to learn to use git, download [the zip file](https://github.com/avehtari/BDA_course_Aalto/archive/master.zip). Remember to download the latest updates.
...
**Reinstall:** the latest version of `R` and then install `RStan`
