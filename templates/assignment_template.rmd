...
In general all code needed to produce the essential parts needs to be included, so that it is possible to see, for peer reviewers, where errors may have happend. You can always look at the open rubrics to see how and what are asked for in each exercise.
