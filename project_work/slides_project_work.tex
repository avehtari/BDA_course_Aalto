...
\hypersetup{%
  ...
  pdftitle={Stan},
  pdfsubject={Bayesian data analysis - project},
...
%    \item Model selection case studies \url{https://avehtari.github.io/modelselection/casestudies.html} (these focus on the model checking and selection, while you need to have all workflow steps)
  ...
  \item The submitted notebooks need to illustrate the knowledge of the
    Bayesian workflow.
  \item Deadline 23:59 3.12.2023, peergrading deadline 7.12.2023
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item During the evaluation week 12-16.12.2023
...
\begin{frame}
  ...
  \begin{itemize}
  \item Register project group and topic by 7th November
    \begin{itemize}
    ...
    \end{itemize}
  \item During the week starting 7th November, start working on the
  ...
  \item Deadline 4th December, 2023
  \item Oral presentations during the evaluation week 11-15.12.2023
  \end{itemize}
