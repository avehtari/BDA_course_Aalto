...
\begin{frame}
  ...
  \LARGE{\color{navyblue} Modeling student retention}\\
...
\begin{frame}{Modeling student retention}

  \vspace{-0.5\baselineskip}
  \begin{itemize}
  \item Is there difference in student retention in different years?
  \item When making changes to the course and assignment it is useful
    to follow changes in retention
    \begin{itemize}
    \item although external effects (like pandemic) make it difficult
...
\begin{frame}{Modeling student retention}
  ...
  \only<1>{\includegraphics[width=11cm]{student_retention_data_numbers_2023.pdf}}
  \only<2>{\includegraphics[width=11cm]{student_retention_data_2023.pdf}}
...
\begin{frame}[fragile]{Student retention}
  ...
  \begin{itemize}
  \item As we want to compare different years, we use hierarchical models and compare
  \end{itemize}
...
\begin{frame}[fragile]{Student retention -- LOO model comparison}

Latent hierarchical linear vs. latent hierarchical linear + spline

\begin{itemize}
\item $R^2$: 0.92 vs 0.97 in favor of +spline
\item ELPD-difference: 43 (SE 14) in favor of +spline
\end{itemize}
...
\begin{frame}{Student retention latent spline model, year 2023?}
  ...
  \begin{itemize}
  \item 90\% posterior predictive interval for assignment 9 $(155,193)$
  \item<2> Actually observed 179
  \end{itemize}
\end{frame}

\begin{frame}{How does year 2023 compare to others?}

  \vspace{-0.5\baselineskip}
  \only<1>{\hspace{-8mm}\includegraphics[height=3.5cm]{student_retention_sbinom_linpreds_final.pdf}}
  \only<2->{\includegraphics[height=6cm]{student_retention_sbinom_hier_comp_final.pdf}}
...
\begin{frame}{More data}
  ...
  \vspace{-0.5\baselineskip}
  \hspace{-8mm}\includegraphics[width=12cm]{student_retention_data_2025.pdf}
...
\begin{frame}{More data}
  ...
  \vspace{-0.5\baselineskip}
  \hspace{-8mm}\includegraphics[width=12cm]{student_retention_sbinom_ppc_ribbon_grouped_2025.pdf}
...
\begin{frame}
  ...
  \begin{itemize}
  \item MCMC sampling performed well based on the usual convergence diagnostics
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Latent hierarchical model with spline can model 98\% of the
    variation submission numbers
  \item Based on the model checking diagnostics, the model is
    reasonable
  \item Year 2023 retention was slightly above average
  \end{itemize}
  
\end{frame}

\begin{frame}
  \frametitle{Extra hints}

  \begin{itemize}
  \item Following slides discuss some presentation hints
  \end{itemize}
  
\end{frame}

\begin{frame}
  \frametitle{Slide number}

  \begin{itemize}
  \item Slide number helps after the presentation as question askers
    can refer to a specific slide
  \end{itemize}
