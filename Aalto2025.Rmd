---
title: "Bayesian Data Analysis course - Aalto 2025"
date: "Page updated: `r format.Date(file.mtime('Aalto2025.Rmd'),'%Y-%m-%d')`"
editor_options: 
  markdown: 
    wrap: 72
params:
...
**Aalto 2025** course can be taken online except for the final project
...
The schedule links to 2024 (and few 2023) lecture videos until couple hours after the
2025 lecture has been recorded.
...
| 12\. Project presentation advise, Q&A                            |                                                                                                                                                                                                                                | [2025 Project presentation advice](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=eb7dc122-8cb2-4a2a-a019-b39f00cb55e8), [Project presentatio advice slides](project_work/BDA_presentation_example.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Project work                                                                                              | `r sdate("Lecture date", "Week13")`                     | `r sdate("Assignment closes (23:59)", "Week13")` |
...
-   **Lecture `r paste(sday("Lecture date", "Week13"), sdate("Lecture date", "Week13"))` 14:15-16, hall T2, CS building**
    - [2025 Project presentation advice](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=eb7dc122-8cb2-4a2a-a019-b39f00cb55e8)
    - [Project presentatio advice slides](project_work/BDA_presentation_example.pdf)
-   TBA
