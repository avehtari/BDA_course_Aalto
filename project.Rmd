...
according to all the parts of Bayesian workflow studied along the course.
  ...
  - In the beginning of the period II
      - Form a group of 2--3 students. Single student groups are allowed only in exceptional situations.
...
- Form a group and pick a topic. Register the group before end of 7th Nov, 2026. The registration will open before that date.
- Groups can reserve presentation slots after some date in November.
<!-- - Groups of 3 can reserve a presentation slot starting 7th Nov, 2025. 
- Groups of 1-2 can reserve a presentation slot starting 8th Nov, 2025.
- Groups that register late can reserve a presentation slot starting 9th Nov, 2025.
...
- The student who registered the group submits the report pdf in FeedbackFruits (the link is available in MyCourses). If the student who registered the group left the group, someone else submits the report and sends a message to David Kohns informing the change in the group.
...
Project work is done in groups of 2-3 persons. Preferred group size is
...
More details on the presentation sessions in 2025
