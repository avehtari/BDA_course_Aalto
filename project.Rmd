...
- Groups of 3 can reserve a presentation slot starting 8th Nov, 2023. 
- Groups of 1-2 can reserve a presentation slot starting 9th Nov, 2023.
- Groups that register late can reserve a presentation slot starting 10th Nov, 2023.
...
do at least some selection of what to show and specficially don't
...
More details on the presentation sessions in 2023
...
If you're looking for inspiration or you're not sure where to begin, here are links to potential data sourcestake a browse over [this list of datasets](https://github.com/awesomedata/awesome-public-datasets) arranged by topic, the datasets mentioned in the [lecture slides](https://github.com/avehtari/BDA_course_Aalto/blob/gh-pages/project_work/slides_project_work.pdf) (see slide 6), or else look at some of these publically accessible databases:
