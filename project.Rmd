...
- Form a group and pick a topic. Register the group before TBA.
...
- Project report deadline December 6. Submit in peergrade (separate "class", the link will be added to MyCourses).
- Project report peer grading December 7-9 (so that you'll get feedback for the report before the presentations).
- Project presentations December 13-17.
