...
1. This BDA course instance is aimed to support learning with peer
   ...
   the course chat, there is peer-grading platform to get feedback
...
1. You will not get a formal certificate for passing the course from
   Aalto University. 
1. The communication happens in the course chat, please don't email
   the lecturer or TAs.
...
We use [peergrade.io](peergrade.io) for providing peer feedback for
...
- Make and submit [Assignment 1](assignments/assignment1.pdf). **Deadline Friday 12.3. 23:59**
...
- Make and submit [Assignment 2](assignments/assignment2.pdf). **Deadline Friday 19.3. 23:59**
    - [Rubric questions used in peergrading for Assignment 2](assignments/assignment2_rubric.html)
    - Review Assignment 1 done by your peers before 23:59 17.3.
...
- Make and submit [Assignment 3](assignments/assignment3.pdf). **Deadline Friday 26.3. 23:59**
    - [Rubric questions used in peergrading for Assignment 3](assignments/assignment3_rubric.html)
    - Review Assignment 2 done by your peers  before 23:59 24.3., and reflect on your feedback
...
- Make and submit [Assignment 4](assignments/assignment4.pdf). **Deadline Friday 9.4. 23:59**
    - [Rubric questions used in peergrading for Assignment 4](assignments/assignment4_rubric.html)
    - Review Assignment 3 done by your peers before 23:59 7.4., and reflect on your feedback
...
- Make and submit [Assignment 5](assignments/assignment5.pdf). **Deadline Friday 16.4. 23:59**
    - [Rubric questions used in peergrading for Assignment 5](assignments/assignment5_rubric.html)
    - Review Assignment 4 done by your peers before 23:59 14.4., and reflect on your feedback
...
- Make and submit [Assignment 6](assignments/assignment6.pdf). **Deadline Friday 23.4. 23:59**
    - [Rubric questions used in peergrading for Assignment 6](assignments/assignment6_rubric.html)
    - Review Assignment 5 done by your peers before 23:59 21.4., and reflect on your feedback
...
- Make and submit [Assignment 7](assignments/assignment7.pdf). **Deadline Friday 30.4. 23:59**
    - [Rubric questions used in peergrading for Assignment 7](assignments/assignment7_rubric.html)
    - Review Assignment 6 done by your peers before 23:59 28.4., and reflect on your feedback
...
- Additional reading material
    - [Model selection](https://avehtari.github.io/modelselection/)
    - [Cross-validation FAQ](https://avehtari.github.io/modelselection/CV-FAQ.html)
- Make and submit [Assignment 8](assignments/assignment8.pdf). **Deadline Friday 7.5. 23:59**
    - [Rubric questions used in peergrading for Assignment 8](assignments/assignment8_rubric.html)
    - Review Assignment 7 done by your peers before 23:59 5.5., and reflect on your feedback
...
- Make and submit [Assignment 9](assignments/assignment9.pdf). **Deadline Friday 14.5. 23:59**
    - [Rubric questions used in peergrading for Assignment 9](assignments/assignment9_rubric.html)
    - Review Assignment 8 done by your peers before 23:59 12.5., and reflect on your feedback
...
- No new assignment. Work on project. 
    - Review Assignment 9 done by your peers before 23:59 19.5., and reflect on your feedback
...
- Watch [Lecture 12.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=e998b5dd-bf8e-42da-9f7c-ab1700ca2702) on frequency evaluation, hypothesis testing and variable selection and [Lecture 12.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=c43c862a-a5a4-45da-9b27-ab1700e12012) overview of modeling data collection, BDA3 Ch 8, linear models, BDA Ch 14-18, lasso, horseshoe and Gaussian processes, BDA3 Ch 21.
    - [Slides](https://github.com/avehtari/BDA_course_Aalto/tree/master/slides)
- Work on project. TAs help with projects. **Project deadline 21.5. 23:59**

### 13) Project evaluation

- Project report deadline 21.5. 23:59 (submit to peergrade).
    - Review project reports done by your peers before 26.5. 23:59, and reflect on your feedback
