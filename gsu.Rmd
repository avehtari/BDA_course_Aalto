---
title: "Bayesian Data Analysis course - Global South 2021"
date: "Page updated: `r format.Date(file.mtime('gsu.Rmd'),'%Y-%m-%d')`"
---

Bayesian data analysis global south version 2021
...
1. This BDA course instance is aimed to support learning with peer
   ...
   about your assignment solutions, and voluntary TAs help answering questions.
...
also maximum for our peergrading platform license. Please consider
carefully before registering that you can commit for this 12 week
course with a lot of work. If you are not certain whether you can
commit, you can self-study all the material anyway. In this course
instance, we prioritize students from global south, but will accept
students from other underrepresented groups.

To register fill in your information (email, country, whether from
global south, prerequisites check) at ...
...
- The primary communication channel is the course slack.
    - link to a slack workspace be added soon
...
DATES TO BE CHANGED when the starting date has been decided!
...
- Make and submit [Assignment 2](assignments/assignment2.pdf). **Deadline Friday 19.3. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 2](assignments/assignment2_rubric.html)
    - Review Assignment 1 done by your peers before 23:59 EET/CAT/UTC+2 17.3.
...
- Make and submit [Assignment 3](assignments/assignment3.pdf). **Deadline Friday 26.3. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 3](assignments/assignment3_rubric.html)
    - Review Assignment 2 done by your peers  before 23:59 EET/CAT/UTC+2 24.3., and reflect on your feedback
...
- Make and submit [Assignment 4](assignments/assignment4.pdf). **Deadline Friday 9.4. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 4](assignments/assignment4_rubric.html)
    - Review Assignment 3 done by your peers before 23:59 EET/CAT/UTC+2 7.4., and reflect on your feedback
...
- Make and submit [Assignment 5](assignments/assignment5.pdf). **Deadline Friday 16.4. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 5](assignments/assignment5_rubric.html)
    - Review Assignment 4 done by your peers before 23:59 EET/CAT/UTC+2 14.4., and reflect on your feedback
...
- Make and submit [Assignment 6](assignments/assignment6.pdf). **Deadline Friday 23.4. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 6](assignments/assignment6_rubric.html)
    - Review Assignment 5 done by your peers before 23:59 EET/CAT/UTC+2 21.4., and reflect on your feedback
...
- Make and submit [Assignment 7](assignments/assignment7.pdf). **Deadline Friday 30.4. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 7](assignments/assignment7_rubric.html)
    - Review Assignment 6 done by your peers before 23:59 EET/CAT/UTC+2 28.4., and reflect on your feedback
...
- Additional reading material
    - [Model selection](https://avehtari.github.io/modelselection/)
    - [Cross-validation FAQ](https://avehtari.github.io/modelselection/CV-FAQ.html)
- Make and submit [Assignment 8](assignments/assignment8.pdf). **Deadline Friday 7.5. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 8](assignments/assignment8_rubric.html)
    - Review Assignment 7 done by your peers before 23:59 EET/CAT/UTC+2 5.5., and reflect on your feedback
...
- Make and submit [Assignment 9](assignments/assignment9.pdf). **Deadline Friday 14.5. 23:59 EET/CAT/UTC+2**
    - [Rubric questions used in peergrading for Assignment 9](assignments/assignment9_rubric.html)
    - Review Assignment 8 done by your peers before 23:59 EET/CAT/UTC+2 12.5., and reflect on your feedback
...
- No new assignment. Work on project. 
    - Review Assignment 9 done by your peers before 23:59 EET/CAT/UTC+2 19.5., and reflect on your feedback
...
- Watch [Lecture 12.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=e998b5dd-bf8e-42da-9f7c-ab1700ca2702) on frequency evaluation, hypothesis testing and variable selection and [Lecture 12.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=c43c862a-a5a4-45da-9b27-ab1700e12012) overview of modeling data collection, BDA3 Ch 8, linear models, BDA Ch 14-18, lasso, horseshoe and Gaussian processes, BDA3 Ch 21.
    - [Slides](https://github.com/avehtari/BDA_course_Aalto/tree/master/slides)
- Work on project. TAs help with projects. **Project deadline 21.5. 23:59 EET/CAT/UTC+2**

### 13) Project evaluation

- Project report deadline 21.5. 23:59 EET/CAT/UTC+2 (submit to peergrade).
    - Review project reports done by your peers before 26.5. 23:59 EET/CAT/UTC+2, and reflect on your feedback
