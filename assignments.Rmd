...
If you are a student on this course, you are allowed to discuss assignments with your friends, but do not copy solutions directly from other students or from internet. You can copy e.g. plotting code from the course material and internet, but really try to solve the actual assignment problems with your own code and explanations. The usual student reports have wonderful variety. We have all of your reports and it's easy to find reports that directly copied or even with modifications. Plagiarism and sharing your reports will have consequences in the the course and will put your reputation in danger. Copying of solutions don't help you to learn, and time used investigatie these cases is away from other useful work we could do for the course. 

## Weekly assignments

There are 9 weekly assignments (two of them have two weeks to
submit). Assignments are linked from [the schedule](Aalto2020.html#Schedule_2020) and can also be found from [git repo assignments
...
For those who are self studying or who miss several assignment hand-ins, there
is a possibility to hand in all assignments once in January. We still strongly
recommend students taking the course to follow the weekly submission deadlines
to more evenly spread the work for them and the reviewers during the course.

## Peergrade

Register to peergrade with your Aalto-email so that we can connect
your peergrade scores to the correct person. The class code needed for
registration will be posted to all registered students before the
course starts.

## Peergrading / feedback

Peergading is called giving feedback in peergrade.io. Giving feedback
...
technical correcteness and small part about the presentation.
...
course chat activity and by answering a time usage questionnaire on the course page in mycourses.
...
After each assignment, a voluntary anonymous questionnaire is opened on [the course page in mycourses](https://mycourses.aalto.fi/course/view.php?id=28239) for the peergrading feedback period (Monday 8:00 to Wednesday 23:59).
