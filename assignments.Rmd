...
changes in the assignments. The assignment instructions are changing
and the currently linked instructions are for year 2023.**
...
-   Most of the assignments are submitted via MyCourses Quiz questions.
...
12pm of the hand-in period of the corresponding assignment week (See the
deadlines below, e.g. the first assignment is not guaranteed to be up to
date until `r sdate("Assignment opens (08:00)", "Week1")` at 12pm).
