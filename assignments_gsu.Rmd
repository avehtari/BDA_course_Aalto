...
If you are a student on this course, you are allowed to discuss assignments with your friends, but it is not allowed to copy solutions directly from other students or from internet. You can copy, e.g., plotting code from the course demos, but really try to solve the actual assignment problems with your own code and explanations. Do not share your answers publicly. 

## Weekly assignments

There are 9 weekly assignments. Assignments are linked from [the schedule](gsu2022.html#Schedule_2022) and can also be found from [git repo assignments
...
in [the course schedule](gsu2022.html#Schedule_2022).
...
period). The deadlines are on Fridays 23:59 (UTC+3). We can't accept late submissions due to the peergrading process.
