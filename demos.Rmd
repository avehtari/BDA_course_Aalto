...
- [CmdStanPy](https://github.com/avehtari/BDA_py_demos/tree/master/demos_cmdstanpy)
    - [CmdStanPy test installation](https://github.com/avehtari/BDA_py_demos/blob/master/demos_cmdstanpy/cmdstanpy_test_installation.ipynb)
    - [CmdStanPy demos](https://github.com/avehtari/BDA_py_demos/blob/master/demos_cmdstanpy/cmdstanpy_demo.ipynb)
