---
title: "Bayesian Data Analysis course - Aalto 2026"
date: "Page updated: `r format.Date(file.mtime('Aalto2026.Rmd'),'%Y-%m-%d')`"
editor_options: 
  markdown: 
    wrap: 72
params:
  schedule_file: "schedule2026.csv"
  project_dl: "29.11."
  project_feedback_dl: "2.12."
  project_presentations: "7-11.12."
  exam_week_lecture_date: "12.10."
---
...
**Aalto 2026** course can be taken online except for the final project
presentation and e-exam. The lectures will be given on campus, but recorded, and the
recording will be made available online after the lecture. If you are
unable to register for the course at the moment in the Sisu system, there is no
...
you can also ask in Zulip at the same times. You can choose which
TA session to join each week separately, without a need to register
for those sessions.

- [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818) is
  used for initial announcements, linking to Zulip, assignments,
...
-   Use of AI is allowed in the course, but most of the work needs to be done by the student, and you need to report
    whether you used AI and in which way you used them (See [points 5 and 6 in Aalto guidelines for use of AI in teaching](https://www.aalto.fi/en/services/guidance-for-the-use-of-artificial-intelligence-in-teaching-and-learning-at-aalto-university)). We have tested some AI on the course topics and assignments and the output can be copy of existing text without attribution (ie plagiarism), vague or have mistakes, so you need to be careful when using such outputs. We provide an Aalto AI student assistant in [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818) (see [Aalto AI assistant](#aalto-ai-student-assistant) for further information)

All the course material is available in a [git
repo](https://github.com/avehtari/BDA_course_Aalto) and in [Panopto](https://aalto.cloud.panopto.eu/Panopto/Pages/Sessions/List.aspx#folderID=%22f1a49586-a32a-4a52-8aa0-b34700b93e8b%22), (and these pages are
...
clone the repo and pull before checking for new material. If you don't want
...
and many bookstores. Aalto library also has copies. See also [home page
...
## Aalto AI student assistant

This year we provide an AI assistant to support your work in the BDA course.
You can find it in [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818)
under **BDA AI Student Assistant**. The assistant has the lecture slides, the
course notes, and selected chapters of Bayesian data analysis (Gelman et al., 2021)
and Bayesian Workflow (Gelman, Vehtari, & McElreath, 2026) as its context, and
it answers from that material, using the respective notation and terminology.

Please use it mindfully. Reading a clear explanation feels like understanding,
but understanding is what you can reconstruct without the text in front of you.
Two habits that may help: (1) state your own understanding first and ask the
assistant to find the gaps, and (2) end each session by explaining the concept
in your own words without looking.

Example prompts:

+ Explain the difference between probability and likelihood. Give a short example of each.
+ Give me a toy example that makes the difference between a pmf and a pdf concrete.
+ I think likelihood is just probability seen as a function of the parameter. Where is my understanding incomplete?
+ Ask me three questions that test whether I understand Bayes' rule. Do not give the answers.
+ I will explain the posterior predictive distribution in my own words. Tell me what I got wrong: [your explanation].
+ I want to understand the difference between prior, likelihood, and posterior. Provide me with a little toy example that I can implement in R 4.5.1 and run by myself.
...
If you find BDA3 too difficult to start with, we recommend
...
-   [Richard McElreath: Statistical Rethinking, 2nd
    ...
    as the BDA course. Richard's lecture videos of [Statistical Rethinking:
...
-   [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818) is
    used for some initial announcements, Quizzes, linking to Zulip, and
    FeedbackFruits.
-   The primary communication channel is the Zulip course chat (link in
    MyCourses, login with your Aalto account)
    ...
    -   The lecturer and teaching assistants have names with "(staff)"
        or "(TA)" at the end of their names.
-   A weekly lecture time on campus includes time for questions and
    answers
...
[Assignments](assignments.html) (40%), exam studio e-exam (10%), and a [project
work with presentation](project.html) (50%). A minimum of 50% of points
...
The course consists of 12 lectures, 9 assignments, an exam studio e-exam, a project work, and
a project presentation in periods I and II. It's good to start reading
the material for the next lecture and assignment while working on the
...
and assignments. Exam studio bookings for e-exam will open later, and
the possible dates for making e-exam are between 17 November and 12
December (with more dates in January and February).
...
an assignment related to the previous lecture, it is good to start reading
the book chapters related to the next lecture and assignment.
The schedule links to 2025 lecture videos (or previous years in case of problems with 2025's recordings) until a couple of hours after the 2026 lecture has been recorded.

|                                                 | Readings                                                                                                                                                                                                                                                                                              | Lectures                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Assignment                                                                                                | Lecture Date                                            | Assignment due date                              |
|-----------|:----------|-----------|-----------|-----------|-----------|
| 1\. Introduction                                | [BDA3 Chapter 1](BDA3_notes.html#ch1)                                                                                                                                                                                                                                                     | [2025 Lecture 1.1 Introduction](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=02178f32-ecc0-41bb-9b22-b4b700bbb726), <br> [2025 Lecture 1.2 Course practicalities](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=b72d65c8-d53e-4b11-810f-b4b700ca660c), <br>[Slides 1.1](slides/BDA_lecture_1a.pdf),<br> [Slides 1.2](slides/BDA_lecture_1b.pdf)                                                                                                                                                                                                                                                                                                                                                                | [Assignment 1](https://avehtari.github.io/BDA_course_Aalto/assignments/assignment1.html) | `r sdate("Lecture date", "Week1")`                      | `r sdate("Assignment closes (23:59)", "Week1")`  |
| 2\. Basics of Bayesian inference                | [BDA3 Chapter 1](BDA3_notes.html#ch1), <br> [BDA3 Chapter 2](BDA3_notes.html#ch2)                                                                                                                                                                                             | [2025 Lecture 2.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=67ac8899-7b24-4645-b348-b35200ba1264), <br> [2025 Lecture 2.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=daf245cc-eb4d-4a0c-9d68-b35200c9df6b), <br>[Slides 2](slides/BDA_lecture_2.pdf) | [Assignment 2](assignments/assignment2.html) | `r sdate("Lecture date", "Week2")`                      | `r sdate("Assignment closes (23:59)", "Week2")`  |
| 3\. Multidimensional posterior                  | [BDA3 Chapter 3](BDA3_notes.html#ch3)                                                                                                                                                                                                                                                     | [2025 Lecture 3.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=3ab53b1f-20fc-4de5-b5e3-b35900ba70a4),<br> [2025 Lecture 3.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=52afd37f-a3cb-40bb-93ed-b35900cb58f0)<br>[Slides 3](slides/BDA_lecture_3.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | [Assignment 3](assignments/assignment3.html) | `r sdate("Lecture date", "Week3")`                      | `r sdate("Assignment closes (23:59)", "Week3")`  |
| 4\. Monte Carlo                                 | [BDA3 Chapter 10](BDA3_notes.html#ch10)                                                                                                                                                                                                                                                   | [2025 Lecture 4.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=95828315-d6c6-42fb-b22d-b36000b97b44),<br> [2025 Lecture 4.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=85dfdf09-cd99-4946-bd22-b36000c8d0f2), <br>[Slides 4](slides/BDA_lecture_4.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | [Assignment 4](assignments/assignment4.html) | `r sdate("Lecture date", "Week4")`                      | `r sdate("Assignment closes (23:59)", "Week4")`  |
| 5\. Markov chain Monte Carlo                    | [BDA3 Chapter 11](BDA3_notes.html#ch11)                                                                                                                                                                                                                                                   | [2025 Lecture 5.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=59d0aadb-9483-469c-a3f4-b36700b96f74), <br> [2025 Lecture 5.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=cc5e5900-b30b-4ebd-84d0-b36700c85cc4), <br>[Slides 5](slides/BDA_lecture_5.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [Assignment 5](assignments/assignment5.html) | `r sdate("Lecture date", "Week5")`                      | `r sdate("Assignment closes (23:59)", "Week5")`  |
| 6\. Stan, HMC, PPL                              | [BDA3 Chapter 12](BDA3_notes.html#ch12) + [extra material on Stan](index.html#stan)                                                                                                                                                                                                       | [2025 Lecture 6.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=bffeedc7-36d4-4778-ab1b-b36e00b9a812), <br>[Lecture 6.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=02ad3174-ae8b-478c-862f-b36e00ca9659), <br>[Slides 6](slides/BDA_lecture_6.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | [Assignment 6](assignments/assignment6.html) | `r sdate("Lecture date", "Week6")`                      | `r sdate("Assignment closes (23:59)", "Week6")`  |
| 7\. Hierarchical models and exchangeability     | [BDA3 Chapter 5](BDA3_notes.html#ch5)                                                                                                                                                                                                                                                     | [2025 Lecture 7.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=91379f62-583c-410b-a509-b37c00bb9609), <br> [2025 Lecture 7.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a19532c2-c3d6-4688-a96d-b37c00cb1f42), <br>[Slides 7](slides/BDA_lecture_7.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | [Assignment 7](assignments/assignment7.html) | `r sdate("Lecture date", "Week8")`                      | `r sdate("Assignment closes (23:59)", "Week8")`  |
| 8\. Model checking & cross-validation           | [BDA3 Chapter 6](BDA3_notes.html#ch6), [BDA3 Chapter 7](BDA3_notes.html#ch7), [Visualization in Bayesian workflow](https://doi.org/10.1111/rssa.12378), [Practical Bayesian cross-validation](https://arxiv.org/abs/1507.04544) | [2025 Lecture 8.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=fc3c9220-cd04-4b17-b6f4-b38300ca5e12), <br> [2024 Lecture 8.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=f25a56b5-492b-4c5d-974f-b38300da456a), <br>[Slides 8a](slides/BDA_lecture_8a.pdf),[Slides 8b](slides/BDA_lecture_8b.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Start project work                                                                                        | `r sdate("Lecture date", "Week9")`                      | `r sdate("Assignment closes (23:59)", "Week9")`  |
| 9\. Model comparison, selection, and hypothesis testing              | [BDA3 Chapter 7 (not 7.2 and 7.3)](BDA3_notes.html#ch7), <br> [Practical Bayesian cross-validation](https://arxiv.org/abs/1507.04544)                                                                                                       | [2025 Lecture 9.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=8ff95182-0a49-4f53-a2c4-b38a00caa423), <br> [2025 Lecture 9.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=04350ffd-4379-4ada-87ce-b38a00d925e8), <br>[Slides 9](slides/BDA_lecture_9.pdf)                                                                                                                                                                                                                                                                                                                                                                            | [Assignment 8](assignments/assignment8.html) | `r sdate("Lecture date", "Week10")`                     | `r sdate("Assignment closes (23:59)", "Week10")` |
| 10\. Decision analysis, R2D2 prior, normal approximation             | [BDA3 Chapter 9](BDA3_notes.html#ch9)                                                                                                                                                                                                                                                     | [2025 Lecture 10.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=f5e55c11-c090-4c7e-92d3-b39100ca289d), [2025 Lecture 10.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=40fdc2d7-2d31-4e73-bcde-b39100ddd864), <br>[Slides 10a](slides/BDA_lecture_10a.pdf), [Slides 10c](slides/BDA_lecture_10c.pdf), [Slides 10b](slides/BDA_lecture_10b.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | [Assignment 9](assignments/assignment9.html) | `r sdate("Lecture date", "Week11")`                     | `r sdate("Assignment closes (23:59)", "Week11")` |
| 11\. Prior-likelihood sensitivity, variable selection, Bayesian Python packages| [BDA3 Chapter 4](BDA3_notes.html#ch4)                                                                                                                                                                                                                                           | [2025 Lecture 11.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=d3cc9d13-1dcb-4b9b-8d14-b39800ca2caf), <br>[2025 Lecture 11.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a505ac2d-a3f6-4b39-b670-b39800d1c38b), <br>[Slides 11a](slides/BDA_lecture_11a.pdf), [Slides 11b](slides/BDA_lecture_11b.pdf)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Project work                                                                                              | `r sdate("Lecture date", "Week12")`                     | `r sdate("Assignment closes (23:59)", "Week12")` |
| 12\. Project presentation advise, Q&A                            |                                                                                                                                                                                                                                | [2024 Project presentation advice](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=96c2784a-0546-48bd-a7b8-b23300e28008)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Project work                                                                                              | `r sdate("Lecture date", "Week13")`                     | `r sdate("Assignment closes (23:59)", "Week13")` |
...
-   Introduction/practicalities **lecture
    ...
    - [2025 Lecture 1.1 Introduction](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=02178f32-ecc0-41bb-9b22-b4b700bbb726), [2025 Lecture 1.2 Course practicalities](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=b72d65c8-d53e-4b11-810f-b4b700ca660c)
...
-   Make and submit [Assignment 1](https://avehtari.github.io/BDA_course_Aalto/assignments/assignment1.html).
    **Deadline
    ...
    -   this assignment checks that you have sufficient prerequisite
        skills (basic probability calculus, and programming)
...
-   **Lecture
    ...
    -   Videos: [2025 Lecture 2.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=67ac8899-7b24-4645-b348-b35200ba1264), [2025 Lecture 2.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=daf245cc-eb4d-4a0c-9d68-b35200c9df6b)
...
-   **Lecture
    ...
    -   Videos: [2025 Lecture 3.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=3ab53b1f-20fc-4de5-b5e3-b35900ba70a4) [2025 Lecture 3.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=52afd37f-a3cb-40bb-93ed-b35900cb58f0) on multiparameter models, joint, marginal and conditional
...
-   **Lecture
    ...
    -   Videos: [2025 Lecture 4.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=95828315-d6c6-42fb-b22d-b36000b97b44)
    on numerical issues, Monte Carlo, how many simulation draws are
    needed, how many digits to report, and [2025 Lecture 4.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=85dfdf09-cd99-4946-bd22-b36000c8d0f2)
    on Pareto-$\hat{k}$ diagnostic, direct simulation, rejection sampling,
...
-   **Lecture
    ...
    -   Videos: [2025 Lecture 5.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=59d0aadb-9483-469c-a3f4-b36700b96f74) on Markov chain Monte Carlo, Gibbs sampling, Metropolis algorithm,
    and [2025 Lecture 5.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=cc5e5900-b30b-4ebd-84d0-b36700c85cc4)
...
-   **Lecture
    ...
    -   Videos: [2025 Lecture 6.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=bffeedc7-36d4-4778-ab1b-b36e00b9a812) on HMC, NUTS, dynamic HMC and HMC specific convergence diagnostics,
    and [2025 Lecture 6.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=02ad3174-ae8b-478c-862f-b36e00ca9659) on probabilistic programming and Stan. BDA3 Ch 12 + [extra
    material](#stan).
...
-   **Lecture `r paste(sday("Lecture date", "Week9"), sdate("Lecture date", "Week9"))` 14:15-16, hall T2, CS building**
    ...
    -   Videos: [2024 Lecture 8.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=fc3c9220-cd04-4b17-b6f4-b38300ca5e12) on model checking, and [2024 Lecture 8.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=f25a56b5-492b-4c5d-974f-b38300da456a) on cross-validation part 1. BDA3 Ch 6-7 + extra material.
...
-   **Lecture `r paste(sday("Lecture date", "Week10"), sdate("Lecture date", "Week10"))` 14:15-16, hall T2, CS building**
    ...
    -   Videos: [Lecture 9.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=8ff95182-0a49-4f53-a2c4-b38a00caa423) and [Lecture 9.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=04350ffd-4379-4ada-87ce-b38a00d925e8) on model comparison, selection, and hypothesis testing.
-   Additional reading material
...
-   **Lecture `r paste(sday("Lecture date", "Week11"), sdate("Lecture date", "Week11"))` 14:15-16, hall T2, CS building**
    -   [Slides 10a](slides/BDA_lecture_10a.pdf), [Slides 10c](slides/BDA_lecture_10c.pdf), [Slides 10b](slides/BDA_lecture_10b.pdf)
    -   Videos: [2025 Lecture 10.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=f5e55c11-c090-4c7e-92d3-b39100ca289d)
    on decision analysis, BDA3 Ch 9, and R2D2 prior, and [2025 Lecture 10.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=40fdc2d7-2d31-4e73-bcde-b39100ddd864) on normal approximations, BDA3 Ch 4.
...
### 11) Prior-likelihood sensitivity, variable selection, Bayesian Python packages

-   **Lecture `r paste(sday("Lecture date", "Week12"), sdate("Lecture date", "Week12"))` 14:15-16, hall T2, CS building**
    -   Videos: [2025 Lecture 11.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=d3cc9d13-1dcb-4b9b-8d14-b39800ca2caf) on prior-likelihood sensitivity and [2025 Lecture 11.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a505ac2d-a3f6-4b39-b670-b39800d1c38b) on variable selection and Bayesian Python packages.
    -   [Slides 11a](slides/BDA_lecture_11a.pdf), [Slides 11b](slides/BDA_lecture_11b.pdf)
...
-   **Lecture `r paste(sday("Lecture date", "Week13"), sdate("Lecture date", "Week13"))` 14:15-16, hall T2, CS building**
    - [2024 Project presentation advice](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=96c2784a-0546-48bd-a7b8-b23300e28008)
...
-   Project report deadline `r params$project_dl` 23:59 (submit to
    FeedbackFruits linked in MyCourses).
...
-   For learning R programming basics
    -   [R Bootcamp](https://r-bootcamp.netlify.app/) Very short interactive tutorial for ggplot2 and handling dataframes.
...
-   For learning basic and advanced plotting using R
    -   [Andrew Heiss, Data Visualiztion with R, Interactive lessons](https://datavizf24.classes.andrewheiss.com/lesson/)
    -   [Robert Kabacoff, Modern Data Visualization with R, Online book](https://rkabacoff.github.io/datavis/index.html)
