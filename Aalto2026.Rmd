...
- [MyCourses](https://mycourses.aalto.fi/course/view.php?id=47496) is
...
December (with more dates in Jannuary and February).
...
-   For learning R programming basics
    -   [R Bootcamp](https://r-bootcamp.netlify.app/) Very short interactive tutorial for ggplot2 and nadling dataframes.
