...
You find it in [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818)
under **BDA AI Student Assistant**. The assistant has the lecture slides, the
course notes, selected chapters of Bayesian data analysis (Gelman et al., 2021)
...
-   [MyCourses](https://mycourses.aalto.fi/course/view.php?id=51818) is
    used for some intial announcements, Quizzes, linking to Zulip, and
    FeedbackFruits.
...
The course consists of 12 lectures, 9 assignments, exam studio e-exam, a project work, and
...
The schedule links to 2025 lecture videos (or previous years in case of problems with 2025's recordings) until couple hours after the
2026 lecture has been recorded.
