...
\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 6 can be found \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/assignments/assignment6_rubric.md}{\textbf{here}}
