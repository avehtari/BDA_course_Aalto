...
This assignment is related to Chapters 2 and 3. The maximum amount of points from this assignment is 9. Use \href{https://hbiostat.org/blog/post/bayes-freq-stmts/}{Frank Harrell's recommendations} on how to state results in Bayesian two group comparisons (and note that there is no point null hypothesis testing in this assignment).

\textbf{Reading instructions:} Chapter 2 and 3 in BDA3, see \href{https://avehtari.github.io/BDA_course_Aalto/chapter_notes/BDA_notes_ch2.pdf}{\textbf{the reading instructions for Chapter 2}} and \href{https://avehtari.github.io/BDA_course_Aalto/chapter_notes/BDA_notes_ch3.pdf}{\textbf{the reading instructions for Chapter 3}}.

\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 3 can be found \href{https://avehtari.github.io/BDA_course_Aalto/assignments/assignment3_rubric.md}{\textbf{in the rubric}}.
...
@
\item Use at least two different priors, and discuss the sensitivity of your inference
...
\item What can you say about $\mu_d = \mu_1 - \mu_2$? Summarize your
  ...
  group comparison.
\item Given this specific model, what is the probability that the means are
