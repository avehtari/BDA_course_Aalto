...
- A recommended template ([html](template3.html), [qmd](template3.qmd), [pdf](template3.pdf)) which uses some additional packages, 
which however requires a bit more set-up work to run and
- a simple template ([html](simple_template3.html), [qmd](simple_template3.qmd), [pdf](simple_template3.pdf)) which doesn't use those additional packages and 
