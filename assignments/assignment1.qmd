...
We prepared a **[quarto template specific to this assignment](template1.html)**, to help you get started. 
...
* Is the probability interval in d) roughly **...**? Remember that since the interval is computed from random sample, there is variation and the answers should be roughly the same!
