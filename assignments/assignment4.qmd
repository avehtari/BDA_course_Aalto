...
We have prepared a **[quarto template specific for this assignment](template4.html)** to help you get started. 
...
*Example:* If you estimate $E(\mu) \approx 1.234$ with MCSE($E(\mu)$) = 0.01, then the true expectation is likely to be between $1.204$ and $1.264$, and it makes sense to report 
$E(\mu) \approx 1.2$.
:::
