...
We have prepared a **[quarto template](template4.html)** to help you get started. 

::: {.hint}             
**Reading instructions:** 

Chapters 3 and 10 in BDA3, see [**the reading
...
relation model that is used in Section 3.7 of the course book and in
[**the chapter reading
instructions**](https://avehtari.github.io/BDA_course_Aalto/chapter_notes/BDA_notes_ch3.pdf).
...
errors (MCSEs) for the mean and quantile estimates and explain in words what does
...
Errata for the book
<http://www.stat.columbia.edu/~gelman/book/errata_bda3.txt>. The
later printings, the online version, and the slides have the
correct equation.*
:::
