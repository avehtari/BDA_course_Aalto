...
\textbf{Reading instructions:} Chapter 7 in BDA3, see \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/chapter_notes/BDA_notes_ch7.pdf}{\textbf{the reading instructions for Chapter 7}}. The [`loo` package vignette on the basics of LOO](https://mc-stan.org/loo/articles/loo2-with-rstan.html) shows an example of how to modify Stan code and use the package with Stan models.
Also read about the PSIS-LOO that in \href{https://link.springer.com/article/10.1007/s11222-016-9696-4}{\textbf{the PSIS-LOO paper}}.

\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 8 can be found \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/assignments/assignment8_rubric.md}{\textbf{in the rubric}}.
...
PSIS-LOO is a recently developed method for approximating the exact LOO and is thus not in BDA3. For more information, see the lecture slides and \href{https://link.springer.com/article/10.1007/s11222-016-9696-4}{\textbf{the original paper}}.
