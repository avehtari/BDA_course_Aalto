...
\textbf{Reading instructions:} Chapter 7 in BDA3, see reading instructions \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/chapter_notes/BDA_notes_ch7.pdf}{\textbf{here}}. Also read about the PSIS-LOO that in \href{https://link.springer.com/article/10.1007/s11222-016-9696-4}{\textbf{this article}} or \href{https://arxiv.org/pdf/1507.04544}{\textbf{the corresponding preprint}}.
