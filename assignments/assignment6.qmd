...
We have prepared a **quarto template specific to this assignment ([html](template6.html), [qmd](template6.qmd), [pdf](template6.pdf))** to help you get started. 
...
You can download [the broken stan file from github](./additional_files/assignment6_linear_model.stan).
