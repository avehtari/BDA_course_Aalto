...
assignment](template6.html)** to help you get started.
...
[JupyterHub](https://jupyter.cs.aalto.fi) has working R and
...
[JupyterHub](https://jupyter.cs.aalto.fi).]{.aalto}

 In your laptop, install package `cmdstanr`. Installation
...
out <- capture.output(
    # Sampling from the posterior	 happens here:
