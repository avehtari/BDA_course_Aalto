...
\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 2 can be found \href{https://avehtari.github.io/BDA_course_Aalto/assignments/ex2_rubric.html}{\textbf{here}}
...
exercise_path <-
  "https://github.com/avehtari/BDA_course_Aalto/blob/master/assignments/tests/ex2.yml"
...
\begin{enumerate}[a)]
\item formulate (1) model likelihood
...
@
\textbf{Note!} Report the values using the data \texttt{algae}, not \texttt{algae\_test}.
