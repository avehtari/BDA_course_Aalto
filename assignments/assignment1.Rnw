...
\textbf{Grading instructions:} The grading will be done in peergrade. All grading questions and evaluations for assignment 1 can be found \href{https://github.com/avehtari/BDA_course_Aalto/blob/master/assignments/assignment1_rubric.md}{\textbf{here}}
...
assignment_path <-
  "https://github.com/avehtari/BDA_course_Aalto/blob/master/assignments/tests/assignment1.yml"
