...
$$
Our task will be to define weakly informative priors for the parameters of the mean $\mu$.
...
:::{.subtask}
Using the above  constraint, choose a conservative lower and upper bound for the weight of any 12-day old chick. Justify your choice with 1-3 sentences.
:::
...
:::{.subtask}
What do you think is a plausible standard deviation of the weight of 12 days-old chicks, based on your range stated above? 
Under the above recommendation, what standard deviation $\sigma$ should you use for your prior?
:::
...
* Do the two standard deviations meet the following common sense criteria?
  - Both values are **...**
* Given the choice of mean from above, the prior's range defined by $\mu \pm 2\sigma$ includes **...**.
::::
...
\begin{aligned}
    ...
    \mu_{j} &\sim N(0,10) \text{ (you need to adjust this)}\\
    \sigma_{j} &\sim \mathrm{exponential}(.02) \text{ (you can use this prior)}
\end{aligned}
$$
