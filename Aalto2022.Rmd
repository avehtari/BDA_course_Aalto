...
-   **Lecture `r paste(sday("Lecture date", "Week8"), sdate("Lecture date", "Week8"))` 14:15-16**
    -   [Slides](https://github.com/avehtari/BDA_course_Aalto/tree/master/slides)
-   [2022 Lecture 7.1](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=6cf678f1-395d-4c91-87c7-af3800da0ff4) on hierarchical models, and [2022 Lecture 7.2](https://aalto.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=2320d64f-1e40-45b0-9b17-af3800c9f435) on exchangeability. BDA3 Ch 5.
-   Read [the additional comments for Chapter
    5](chapter_notes/BDA_notes_ch5.pdf)
-   Check [R demos](demos.html#BDA_R_demos) or [Python
