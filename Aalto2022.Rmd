...
**The first lecture is 5.9.2022! MyCourses and Sisu are showing the wrong starting date!**
...
**Aalto 2022** course can be taken online except for the final project presentation. The lectures will be given on campus, but recorded and the recording will be made available online after the course. If you are unable to register for the course at the moment in the Sisu, there is no need to email the lecturer. You can start taking the course and register before the end of the course. Sisu shows rooms on campus for the computer exercises, but only some of  the computer exercises and TA sessions are on campus and most of the session are online (we are preparing the schedule). You can choose which TA session to join each week separately, without a need to register for those sessions.
 ...
 - [MyCourses](https://mycourses.aalto.fi/course/view.php?id=32457) is used for initial announcements, linking to peergrade, and some questionnaires.
...
- [MyCourses](https://mycourses.aalto.fi/user/index.php?id=28239) is used for some intial announcements, linking to Zulip and Peergrade, and some questionnaires.
...
- Introduction/practicalities lecture **Monday 13.9. 14:15-16**
